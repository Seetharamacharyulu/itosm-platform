            ...
            <div className="flex items-center space-x-3 mb-2 lg:mb-0">
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-2 rounded-lg shadow-sm cursor-pointer">
                    <img 
                      src={geosoftLogo} 
                      alt="GeoSoft Logo" 
                ...
                <TooltipContent>
                  <p>GeoSoft Global-surtech - IT Operations & Service Management Platform</p>
                </TooltipContent>
              </Tooltip>
          ...
          <nav className="flex items-center justify-between lg:justify-end space-x-2 sm:space-x-4 lg:space-x-6">
            <div className="flex items-center space-x-1 sm:space-x-4">
              <Tooltip>
                ...
                <TooltipContent>
                  <p>View your tickets and statistics dashboard</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Create a new service request ticket</p>
                </TooltipContent>
              </Tooltip>
              ...
              {isAdmin() && (
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Admin panel - Manage all tickets, users, and system settings</p>
                  </TooltipContent>
                </Tooltip>
              )}
            </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 pl-2 sm:pl-6 border-l border-border">
              <Tooltip>
                <TooltipTrigger asChild>
                  <span className="text-xs sm:text-sm text-muted-foreground hidden md:block cursor-help" data-testid="user-display">
                    {user?.username}
                  </span>
                </TooltipTrigger>
                <TooltipContent>
                  <p>Logged in as: {user?.username} {user?.isAdmin ? '(Administrator)' : '(User)'}</p>
                </TooltipContent>
              </Tooltip>
              <Tooltip>
                <TooltipTrigger asChild>
